...
//		int hash = 0;
//		
//		for(int i = 0; i< this.soundex.length(); i++)
//		{
//			hash += 31* hash + this.soundex.charAt(i);
//		}
		
//		return hash;
		
		return (this.soundex.charAt(0) - 'a') * 1000 +
			   (this.soundex.charAt(1) - '0') * 100 +
			   (this.soundex.charAt(2) - '0') * 10 +
			   (this.soundex.charAt(3) - '0') * 1 ;
	}
