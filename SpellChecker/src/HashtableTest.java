...
public class HashtableTest {
	...
	public void testPutAndGet() {
		...
		Word w2 = new Word("missspelled");
		List<Word> words2 = Arrays.asList(w2);
		wordsBySoundex.put(w2.getSoundex(), words2);
		Assert.assertEquals(words2, wordsBySoundex.get(w2.getSoundex()));
	}
